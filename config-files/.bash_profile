...
alias ll='ls -al'                           # Preferred 'ls' implementation
...
zipup () { zip -r "$1".zip "$1" ; }          # zipf:         To create a ZIP archive of a folder
...
alias wanip='curl ip.appspot.com'                    # wanip:         Public facing IP Address
...
#   -------------------------------------------------------------------
    ii() {
        ...
        echo -e "\n${RED}Public facing IP Address :$NC " ;wanip
